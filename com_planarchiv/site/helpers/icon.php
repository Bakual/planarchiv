...
abstract class JHtmlIcon
{
	...
	public static function create($category, $params, $attribs = array())
	{
		...
		$url = 'index.php?option=com_planarchiv&task=contact.add&return=' . base64_encode($uri) . '&id=0&catid=' . $category->id;
	...
	public static function edit($contact, $params, $attribs = array(), $legacy = false)
	{
		...
		$url        = 'index.php?option=com_planarchiv&task=contact.edit&id=' . $contact->id . '&return=' . base64_encode($uri);
