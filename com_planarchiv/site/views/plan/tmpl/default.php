	...
	<dl class="plan-info muted">
		...
		<dd class="modified">
			...
			<time datetime="<?php echo HTMLHelper::_('date', $this->item->AenderungsDatum, 'c'); ?>">
				<?php $aenderungsDatum = ($this->item->AenderungsDatum !== '0000-00-00 00:00:00') ? HTMLHelper::_('date', $this->item->AenderungsDatum, Text::_('DATE_FORMAT_LC3')) : '?'; ?>
	...
	<?php else : ?>
		...
		<div class="well well-small">
			<div class="row-fluid">
				...
				<div class="span4">
					<h4><?php echo Text::_('COM_PLANARCHIV_DFA_LABEL'); ?></h4>
					<?php echo $this->escape($this->item->dfa_title) . ' (' . $this->escape($this->item->dfa_code) . $this->item->GebDfaLfnr . ')'; ?>
				</div>
				<div class="span4">
					<h4><?php echo Text::_('COM_PLANARCHIV_STOCKWERK_LABEL'); ?></h4>
