 ...
 * @since          1.0.0
 */
class PlanarchivTablePlanart extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__planarchiv_planart', 'id', $db);

		$this->setColumnAlias('published', 'state');

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_planarchiv.planart'));
	}
