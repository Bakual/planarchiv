 ...
 * @since          1.0.0
 */
class PlanarchivTableOrt extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__planarchiv_ort', 'id', $db);

		$this->setColumnAlias('published', 'state');

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_planarchiv.ort'));
	}
