...
<form action="<?php echo Route::_('index.php?option=com_planarchiv&view=anlagetyps'); ?>" method="post" name="adminForm" id="adminForm">
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a href="<?php echo Route::_('index.php?option=com_planarchiv&task=anlagetyp.edit&id=' . $item->id);?>">
