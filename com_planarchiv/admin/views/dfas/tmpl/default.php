...
<?php endif; ?>
		...
		<?php else : ?>
			<table class="table table-striped" id="dfaList">
				<thead>
					<tr>
						...
						<th width="1%" style="min-width:40px" class="nowrap center">
							<?php echo HTMLHelper::_('searchtools.sort', 'JSTATUS', 'dfas.state', $listDirn, $listOrder); ?>
						</th>
						<th>
						...
						<th width="1%" class="nowrap hidden-phone">
							<?php echo HTMLHelper::_('searchtools.sort',  'JGRID_HEADING_ID', 'dfas.id', $listDirn, $listOrder); ?>
						</th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
						...
						<td class="center">
							<div class="btn-group">
								<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'dfas.', $canChange, 'cb'); ?>
								<?php
								// Create dropdown items
								$action = $archived ? 'unarchive' : 'archive';
								HTMLHelper::_('actionsdropdown.' . $action, 'cb' . $i, 'dfas');
