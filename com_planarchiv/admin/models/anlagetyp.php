 ...
 * @since     1.0.0
 */
class PlanarchivModelAnlagetyp extends JModelAdmin
{
	/**
	...
	protected function loadFormData()
	{
		...
		if (empty($data))
		{
			...
			// Pre-select some filters (Status, Category, Language) in edit form if those have been selected in Anlagetyp Manager: Anlagetyps
