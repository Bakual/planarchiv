...
class PlanarchivModelDidok extends AdminModel
{
	 ...
	 * @since   1.0.0
	 */
	protected $associationsContext = 'com_planarchiv.didok';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_planarchiv.didok', 'didok', array('control' => 'jform', 'load_data' => $loadData));
	 ...
	 * @since    1.0.0
	 */
	public function getTable($type = 'Didok', $prefix = 'PlanarchivTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_planarchiv.edit.didok.data', array());
		...
		$this->preprocessData('com_planarchiv.didok', $data);
