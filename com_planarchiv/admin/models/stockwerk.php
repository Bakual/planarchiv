 ...
 * @since     1.0.0
 */
class PlanarchivModelStockwerk extends JModelAdmin
{
	/**
	 ...
	 * @since   1.0.0
	 */
	protected $associationsContext = 'com_planarchiv.stockwerk';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_planarchiv.stockwerk', 'stockwerk', array('control' => 'jform', 'load_data' => $loadData));
	 ...
	 * @since    1.0.0
	 */
	public function getTable($type = 'Stockwerk', $prefix = 'PlanarchivTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_planarchiv.edit.stockwerk.data', array());
		...
		$this->preprocessData('com_planarchiv.stockwerk', $data);
