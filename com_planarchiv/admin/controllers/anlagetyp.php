...
/**
 * Anlagetyp controller class.
 *
 * @package        PlanArchiv.Administrator
 *
 * @since          1.0.0
 */
class PlanarchivControllerAnlagetyp extends JControllerForm
{
	/**
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		/** @var PlanarchivModelAnlagetyp $model */
		$model      = $this->getModel();
	...
	protected function getRedirectToItemAppend($recordId = null, $urlVar = null)
	{
		...
		$modal  = Factory::getApplication()->input->get('modal', 0, 'int');
